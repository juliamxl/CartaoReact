...
function ContainerCampos(props) {
    ...
    return (
        <form onSubmit={aoSalvar} className="container-campos">
            ...
            <Input label="Nome do titular" type="text" valor={NomeTitular} aoAlterado={valor => setNomeTitular(valor)} placeholder="Cardholder"></Input>
            <Input mask="99/99" label="Expiração" type="text" aoAlterado={valor => setExpiracao(valor)} valor={Expiracao} placeholder="MM/YYYY"></Input>
            <Input mask="9999" label="CVC" type="text" valor={Cvc} aoAlterado={valor => setCVC(valor)} placeholder="CVC">{Cvc}</Input>
